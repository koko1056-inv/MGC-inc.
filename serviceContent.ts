...
export const serviceContent: Content = {
  ja: {
    ...
    'ai-sales': {
      ...
      image: '/assets/service/ai-sales.webp',
      imageWidth: 1800,
      imageHeight: 764,
      imageAlt: '明るいオフィスのデスクに置かれたノートパソコンと、奥にぼかしで写る打ち合わせスペース',
      hero: {
        badge: 'AI Sales',
    ...
    'ai-phone': {
      ...
      image: '/assets/service/ai-phone.webp',
      imageWidth: 1800,
      imageHeight: 764,
      imageAlt: '明るいオフィスのデスクに置かれたヘッドセットとモニター',
      hero: {
        badge: 'Voice AI',
    ...
    'salesforce-ai': {
      ...
      image: '/assets/service/salesforce-ai.webp',
      imageWidth: 1800,
      imageHeight: 764,
      imageAlt: '明るいオフィスのデスクで、抽象的なダッシュボードを表示しているモニター',
      hero: {
        badge: 'Salesforce × AI',
  ...
  en: {
    'ai-sales': {
      ...
      imageWidth: 1800,
      imageHeight: 764,
      imageAlt: 'A laptop on a desk in a bright office, with a blurred meeting area behind',
      hero: {
        badge: 'AI Sales',
    ...
    'ai-phone': {
      ...
      imageWidth: 1800,
      imageHeight: 764,
      imageAlt: 'A headset and monitor on a desk in a bright, minimal office',
      hero: {
        badge: 'Voice AI',
    ...
    'salesforce-ai': {
      ...
      imageWidth: 1800,
      imageHeight: 764,
      imageAlt: 'A monitor showing an abstract dashboard on a desk in a bright office',
      hero: {
        badge: 'Salesforce × AI',
